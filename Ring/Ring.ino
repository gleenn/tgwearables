...
char ssid[] = "detour";  //  your network SSID (name)
char pass[] = "thebeatenpath";  // your network password
//char ssid[] = "Speedbump";  //  your network SSID (name)
//char pass[] = "iwontforgetyou";  // your network password
